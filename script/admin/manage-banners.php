...
<head>
  <meta charset="UTF-8" />
	...
	<title><?php echo WBName; ?> - Manage Banners</title>
  <base href="../">
...
<body id="SELECTOR">
    ...
    <div class="wrapper theme-4-active pimary-color-red">
        ...
        <li class="navigation-header">
          ...
          <li>
            <a class="active" href="admin/manage-banners"><div class="pull-left"><i class="feather icon-grid mr-20"></i><span class="right-nav-text">Manage Banners</span></div><div class="clearfix"></div></a>
          </li>
        </li>
      ...
      <div class="container-fluid pt-25">
        ...
        <div class="row heading-bg">
          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h5 class="txt-dark">Manage Banners</h5>
          </div>
          ...
          <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <li class="active"><span>Manage Banners</span></li>
            </ol>
          </div>
                    ...
                    <div class="table-responsive">
                      <table id="datable_1" class="table table-hover display  pb-30" >
                        ...
                        <tbody>
                          ...
                          $stmt = $conn->prepare("SELECT * FROM tbl_banners ORDER BY id DESC");
                          $stmt->execute();
                          ...
                          foreach($result as $row)
                          {
                            ...
                            <tr>
                              ...
                              <td width="10"><a href="admin/edit-banner?node=<?php echo $row[0]; ?>" class="btn btn-default  btn-xs">Edit</a</td>
                            </tr>
                            <?php
                          }
