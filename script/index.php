			...
			<div class="row">
				<div class="col-md-8">
					...
					<ul class="unstyled top-nav">
						...
						<li><a href="https://www.privacypolicygenerator.info/live.php?token=I9ecgY6P4bYBOJxWqLQhhyNUHfhfbnEI">Privacy Policy</a></li>
					</ul>
				</div>
			...
			<div class="row">
				<div class="col-lg-8 col-md-12">
					...
					<div class="block category-listing category-style2 color-red">
						<h3 class="block-title"><span>Latest Posts</span></h3>
